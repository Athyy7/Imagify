  ...
  return (
    <div className='fixed top-0 left-0 right-0 bottom-0 z-10 backdrop-blur-sm bg-black/30 flex justify-center items-center'>
      ...
      className='relative bg-white p-10 rounded-xl text-slate-500 w-[90%] max-w-md'>
        ...
        <p className='text-center text-sm mb-4'>Welcome back! Please sign in to continue</p>

        {state !== 'Login' &&
        <div className='border px-4 py-2 flex items-center gap-3 rounded-full mt-5'>
          <img src={assets.user_icon} alt="user" className='w-10 h-10 sm:w-6 sm:h-6 object-contain' />
          <input
        ...
        <div className='border px-4 py-2 flex items-center gap-3 rounded-full mt-4'>
          <img src={assets.email_icon} alt="user" className='w-5 h-5 sm:w-6 sm:h-6 object-contain' />
          <input
        ...
        <div className='border px-4 py-2 flex items-center gap-3 rounded-full mt-4'>
          <img src={assets.lock_icon} alt="user" className='w-5 h-5 sm:w-6 sm:h-6 object-contain' />
          <input
